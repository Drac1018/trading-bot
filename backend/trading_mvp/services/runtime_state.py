...
BINANCE_REST_AUTH_PERMISSION_REASON_CODE = "BINANCE_REST_AUTH_PERMISSION_REJECTED"
...
def get_binance_rest_detail(
    ...
    *,
    ...
    if circuit_state == "open":
        current_reason_code = str(payload.get("reason_code") or "").strip()
        entry_block_reason_code = (
            BINANCE_REST_AUTH_PERMISSION_REASON_CODE
            if current_reason_code == BINANCE_REST_AUTH_PERMISSION_REASON_CODE
            else BINANCE_REST_CIRCUIT_OPEN_REASON_CODE
        )
...
def record_binance_rest_issue(
    ...
    *,
    ...
    opens_circuit = (
        ...
        or server_error
        or rate_limited
        or reason_code == BINANCE_REST_AUTH_PERMISSION_REASON_CODE
