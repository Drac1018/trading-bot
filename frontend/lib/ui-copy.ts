const labelMap: Record<string, string> = {
  ...
  app_pause_reason_code: "앱 pause 사유",
  app_pause_origin: "앱 pause 발생 주체",
  ...
  symbol_cadence_overrides: "심볼별 주기 override",
  symbol_effective_cadences: "심볼별 실효 주기",
  timeframe_override: "타임프레임 override",
  market_refresh_interval_minutes_override: "시장 갱신 override",
  position_management_interval_seconds_override: "포지션 관리 override",
  ...
  next_decision_due_at: "다음 신규 판단 예정",
  next_ai_call_due_at: "다음 AI 호출 가능 시각",
  ...
  freshness_seconds: "동기화 최신도",
  stale_after_seconds: "최신도 기준",
...
const reasonCodeMap: Record<string, string> = {
  ...
  AI_DISABLED: "AI가 비활성이라 배치 실행을 건너뜁니다.",
