...
from trading_mvp.schemas import IntegrationSuggestionBatch, TradeDecisionLite


def test_openai_trade_decision_schema_marks_all_properties_required() -> None:
    schema = OpenAIProvider._build_strict_json_schema(TradeDecisionLite)
    ...
    assert "explanation_detailed" not in properties
